...
describe('TransactionCreator', () => {
  ...
  it('should create a valid transaction', async () => {
    ...
    const expectedTransaction = new Transaction(new TransactionId(id), seller_domain, kind, invoice_number, amount, total, status, user_created, user_updated, created_at, updated_at)
